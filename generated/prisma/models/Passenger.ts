...
export type PassengerWhereInput = {
  ...
  id_passenger?: Prisma.IntFilter<"Passenger"> | number
  name?: Prisma.StringNullableFilter<"Passenger"> | string | null
}

export type PassengerOrderByWithRelationInput = {
  id_passenger?: Prisma.SortOrder
...
export type PassengerScalarWhereWithAggregatesInput = {
  ...
  id_passenger?: Prisma.IntWithAggregatesFilter<"Passenger"> | number
  name?: Prisma.StringNullableWithAggregatesFilter<"Passenger"> | string | null
}
...
export type PassengerUncheckedUpdateInput = {
  id_passenger?: Prisma.IntFieldUpdateOperationsInput | number
  name?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
}
...
export type PassengerOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id_passenger" | "name", ExtArgs["result"]["passenger"]>
...
export interface PassengerDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `id_passenger`
   * const passengerWithId_passengerOnly = await prisma.passenger.findMany({ select: { id_passenger: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Passengers and only return the `id_passenger`
   * const passengerWithId_passengerOnly = await prisma.passenger.createManyAndReturn({
   *   select: { id_passenger: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more Passengers and only return the `id_passenger`
   * const passengerWithId_passengerOnly = await prisma.passenger.updateManyAndReturn({
   *   select: { id_passenger: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PassengerFieldRefs {
  readonly id_passenger: Prisma.FieldRef<"Passenger", 'Int'>
